...
vito_retry_apt sudo DEBIAN_FRONTEND=noninteractive apt-get purge -y postgresql-* 2>/dev/null || true
...
vito_retry_apt sudo DEBIAN_FRONTEND=noninteractive apt-get install postgresql-14 -y
