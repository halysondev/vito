...
vito_retry_apt sudo DEBIAN_FRONTEND=noninteractive apt-get purge -y mysql-server mysql-server-* mysql-client mysql-common mysql-community-server 2>/dev/null || true
vito_retry_apt sudo DEBIAN_FRONTEND=noninteractive apt-get autoremove -y 2>/dev/null || true
vito_retry_apt sudo DEBIAN_FRONTEND=noninteractive apt-get autoclean 2>/dev/null || true
...
vito_retry_apt sudo DEBIAN_FRONTEND=noninteractive apt-get install -y wget lsb-release gnupg
...
vito_retry_apt sudo DEBIAN_FRONTEND=noninteractive \
